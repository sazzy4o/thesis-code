...
args = sys.argv[1:]
# args = ['single_model_with_token_random_token_init','5e-5','quail','large', '1', 'soft_attempt_t5_lm'] # ! TODO: Remove this line
############ Config ############
...
if dataset == 'quail':
    out_folder = Path(models_base_name)/f'{model_dir_name}-from-silver-{init_arch}'/args[1]
...
if architecture == 'ghanem_et_al_2022_t5_lm' or architecture == 'single_model_with_hard_prompt_t5_lm' or architecture == 'separate_models_t5_lm':
    base_model = 'google/t5-large-lm-adapt'

if 'ghanem_et_al_2022' in init_arch or 'single_model_with' in init_arch or init_arch == 'control_t5_lm':
    best_map = {
        ('ghanem_et_al_2022_t5_lm',3): 'models-large-3-control/ghanem_et_al_2022_t5_lm-silver_squad/1e-4',
        ('ghanem_et_al_2022_t5_lm',1): 'models-large-1-control/ghanem_et_al_2022_t5_lm-silver_squad/1e-4',
        ('ghanem_et_al_2022_t5_lm',2): 'models-large-2-control/ghanem_et_al_2022_t5_lm-silver_squad/5e-5',
        ('control_t5_lm',2): 'models-large-2-control/control_t5_lm-silver_squad/5e-5',
        ('control_t5_lm',3): 'models-large-3-control/control_t5_lm-silver_squad/1e-4',
        ('control_t5_lm',1): 'models-large-1-control/control_t5_lm-silver_squad/5e-5'
    }
    init_path = best_map[(init_arch,seed)]
    base_model = str((Path(init_path)/'model_files').resolve())
elif 'soft_attempt' in init_arch:
    best_map ={
        ('soft_attempt_t5_lm',2,'Character_identity'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',3,'Character_identity'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',1,'Character_identity'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',3,'Causality'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',1,'Causality'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',2,'Causality'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',3,'Factual'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',1,'Factual'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',2,'Factual'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',3,'Entity_properties'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',1,'Entity_properties'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',2,'Entity_properties'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',3,'Temporal_order'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',2,'Temporal_order'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/1e-2',
        ('soft_attempt_t5_lm',1,'Temporal_order'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',2,'Subsequent_state'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',1,'Subsequent_state'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/2.5e-1',
        ('soft_attempt_t5_lm',3,'Subsequent_state'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',1,'Event_duration'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',2,'Event_duration'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',3,'Event_duration'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/2.5e-2',
        ('soft_attempt_t5_lm',1,'Belief_states'): 'models-large-1-control/soft_attempt_t5_lm-silver_squad/5e-1',
        ('soft_attempt_t5_lm',3,'Belief_states'): 'models-large-3-control/soft_attempt_t5_lm-silver_squad/1e-1',
        ('soft_attempt_t5_lm',2,'Belief_states'): 'models-large-2-control/soft_attempt_t5_lm-silver_squad/5e-2'
    }
...
supported_architectures = [
    ...
    'ghanem_et_al_2022_t5_lm',
    'separate_models',
    'separate_models_t5_lm',
    'single_model',
    ...
    't5_wta_control_init_start_t5_lm'
    'single_model_with_soft_prompt',
    'single_model_with_soft_prompt_t5_lm',
    'single_model_with_hard_prompt',
    'single_model_with_hard_prompt_t5_lm',
    'control_t5_lm',
]
...
if architecture=='separate_models' or architecture == 'separate_models_t5_lm':
...
if "_soft_prompt_patch" in architecture:
    ...
    del patch_tokenizer
    del patch_embeddings
elif architecture == 't5_wta_control_length':
    new_tokens = []
    for prompt in t5_wta_patch_prompt_map.values():
        for token in re.split(r'(?=<)',prompt):
            if token == '':
...
elif architecture == 't5_wta_control_length_and_init':
    tokens_to_add = []
    for prompt in t5_wta_patch_prompt_map.values():
        for token in re.split(r'(?=<)',prompt):
            if token == '':
    ...
    patch_embeddings = model.shared.weight
    ...
    with torch.no_grad():
        ...
        # model.shared.weight[32000:] = patch_embeddings[32000:]
        for init,new_toks in zip(ghanem_et_al_2022_prompt_map.values(),t5_wta_patch_prompt_map.values()):
            init_tokens = tokenizer.encode(init)[:-1]
            new_tokens = tokenizer.encode(new_toks)[:-1]
            assert len(init_tokens) == len(new_tokens)
            model.shared.weight[new_tokens] = patch_embeddings[init_tokens].detach().clone()

    del patch_embeddings

elif architecture == 't5_wta_control_init_striped' or architecture == 't5_wta_control_init_striped_t5_lm':
    new_tokens = [
    ...
    soft_prompt_map = {
        k:''.join(f'<{k}{i}>' for i in range(token_prefix_length)) 
        for k in ghanem_et_al_2022_prompt_map.keys()
    }
    ...
    # Resize embeddings
    with torch.no_grad():
        old_token_count = model.shared.weight.shape[0]
        model.resize_token_embeddings(old_token_count+len(new_tokens))

        patch_embeddings = model.shared.weight
        
        # model.shared.weight[32000:] = patch_embeddings[32000:]
        for init,new_toks in zip(ghanem_et_al_2022_prompt_map.values(),soft_prompt_map.values()):
            init_tokens = tokenizer.encode(init)[:-1]
            new_tokens = tokenizer.encode(new_toks)[:-1]
            init_a, new_a = zip(*list(zip(cycle(init_tokens),new_tokens)))
            assert len(init_a) == len(new_a)
            model.shared.weight[list(new_a)] = patch_embeddings[list(init_a)].detach().clone()

    del patch_embeddings

elif architecture == 't5_wta_control_init_start' or architecture == 't5_wta_control_init_start_t5_lm':
    new_tokens = [
        tok for i in range(token_prefix_length)
        for tok in
        [
    ...
    with torch.no_grad():
        ...
        # model.shared.weight[32000:] = patch_embeddings[32000:]
        for init,new_toks in zip(ghanem_et_al_2022_prompt_map.values(),soft_prompt_map.values()):
            random_token_sample = [get_random_regular_token_id(5000) for _ in range(100)]
            init_tokens = tokenizer.encode(init)[:-1]
            new_tokens = tokenizer.encode(new_toks)[:-1]
            init_a, new_a = zip(*list(zip(list(init_tokens)+random_token_sample,new_tokens)))
            assert len(init_a) == len(new_a)
            model.shared.weight[list(new_a)] = patch_embeddings[list(init_a)].detach().clone()

    del patch_embeddings
elif architecture == 'control_t5_lm':
    new_tokens = [
        tok for i in range(token_prefix_length)
        for tok in
        [
    ...
    with torch.no_grad():
        ...
        for tok_str in new_tokens:
            new_tok = tokenizer.encode(tok_str)[0]
            new_embeddings.weight[new_tok] = old_embeddings.weight[get_random_regular_token_id(5000)].detach().clone()
        ...
        model.config.vocab_size = new_embeddings.weight.shape[0]
elif 'single_model_with_soft_prompt' in architecture:
    new_tokens = [
        f'<SP{i}>' for i in range(token_prefix_length)
    ]
    ...
    with torch.no_grad():
        ...
        # model.shared.weight[32000:] = patch_embeddings[32000:]
        for new_toks in new_tokens:
            random_token_sample = [get_random_regular_token_id(5000) for _ in range(100)]
            new_tokens_encoded = tokenizer.encode(new_toks)[:-1]
            init_a, new_a = zip(*list(zip(random_token_sample,new_tokens_encoded)))
            assert len(init_a) == len(new_a)
            model.shared.weight[list(new_a)] = patch_embeddings[list(init_a)].detach().clone()
...
if '_t5_lm' in architecture:
    model_params["TRAIN_BATCH_SIZE"] = 4
    model_params["GRADIENT_ACCUMULATION_BATCH_SIZE"] = 2
...
if architecture == 'single_model_with_token_random_token_init':
    ...
    with torch.no_grad():
        ...
        model.config.vocab_size = new_embeddings.weight.shape[0]
#%%
if architecture == 'single_model_with_token_random_token_init' and init_arch == 'soft_attempt_t5_lm':
    with torch.no_grad():
        for question_type in question_types:
            q_type_embed = torch.load(
                Path(best_map[(init_arch,seed,question_type)])/f'{question_type}/prefix_embeddings.pt'
            )
            for token_index in range(token_prefix_length):
                new_token = tokenizer.encode(f'<{question_type}{token_index}>')[:-1][0]
                model.shared.weight[new_token] = q_type_embed[token_index].detach().clone()
            del q_type_embed
    model_params["TRAIN_BATCH_SIZE"] = 4
    model_params["GRADIENT_ACCUMULATION_BATCH_SIZE"] = 2
#%%
