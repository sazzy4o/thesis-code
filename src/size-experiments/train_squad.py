...
take = int(args[0]) if args else None
save_path = Path(f"./models/squad-{take}")
...
# model.eval()
# i = 107
# input_ids = tokenizer(dataset["validation"][input_column][i], return_tensors="pt").input_ids.to(device)
# print(dataset["validation"][input_column][i])
# print(input_ids)
